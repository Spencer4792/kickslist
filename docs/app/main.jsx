    ...
    <div className="kl-vendor-comparison">
      ...
      <div className="kl-comparison-section">
        <h3 className="kl-comparison-title">
          ...
          <span className="kl-comparison-subtitle">Authenticated marketplaces</span>
        </h3>
    ...
    <main className="kl-homepage-content">
      ...
      <section className="kl-trust">
        ...
        <div className="kl-trust-item">
          ...
          <div><h4>Where to Buy</h4><p>Direct links to StockX, GOAT & more</p></div>
        </div>
        <div className="kl-trust-item">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <main className="kl-about-page">
      ...
      <section className="kl-about-howitworks">
        ...
        <div className="kl-about-steps">
          <div className="kl-about-step">
            ...
            <h3>We Bring It All Together</h3>
            <p>KicksList gathers 20,000+ sneakers from across the web into one place, with retail pricing and direct links to trusted retailers and resale marketplaces — so you never have to tab-hop again.</p>
          </div>
          <div className="kl-about-step">
            <span className="kl-about-step-num">2</span>
            <h3>You Discover &amp; Decide</h3>
            <p>Browse, search, and filter across top retailers and resale marketplaces — all in one place — to find exactly what you're after.</p>
          </div>
          <div className="kl-about-step">
      ...
      <section className="kl-about-values">
        <div className="kl-about-value">
          ...
          <p>See retail pricing and jump straight to StockX, GOAT, Nike, Foot Locker, and more — without endless tab-hopping across a dozen sites.</p>
        </div>
        <div className="kl-about-value">
...
const FAQPage = () => {
  ...
  const faqs = [
    { q: 'What is KicksList?', a: 'KicksList is a free sneaker discovery platform. We bring together 20,000+ sneakers with retail pricing and direct links to trusted retailers and resale marketplaces, so you can find authentic sneakers — and where to buy them — all in one place.' },
